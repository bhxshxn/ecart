...
export const USER_BECOMESELLER_REQUEST = 'USER_BECOMESELLER_REQUEST';
export const USER_BECOMESELLER_SUCCESS = 'USER_BECOMESELLER_SUCCESS';
export const USER_BECOMESELLER_FAIL = 'USER_BECOMESELLER_FAIL';